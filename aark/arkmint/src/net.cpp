...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AardvarkCoin " + FormatFullVersion();
...
{"3.18.113.105", "3.18.113.105"},
{"3.19.75.167", "3.19.75.167"},
{"18.217.190.157", "18.217.190.157"},
{"18.225.31.205", "18.225.31.205"},
{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AardvarkCoin is probably already running."), addrBind.ToString().c_str());
        else
...
{
    printf("StopNode()\n");
    GenerateAardvarkCoins(false, NULL);
    MapPort(false);
