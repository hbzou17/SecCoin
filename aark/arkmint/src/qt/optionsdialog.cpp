    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new AardvarkCoinUnits(this));
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting AardvarkCoin."), QMessageBox::Ok);
