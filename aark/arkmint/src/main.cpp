...
uint256 hashGenesisBlock("0x4769c8ba52fd4d1629ef5da94c47b17dd595bdc82f62c9922f07188cb6ce493f");
...
const string strMessageMagic = "AardvarkCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
		const char* pszTimestamp = "The AardvarkCoin Coin";
		CTransaction txNew;
		txNew.vin.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x22e9f45608cd3b3b5be81f7cb7882ad8b18855af31c8ead202b2029ee7da06f9"));
        block.print();
