...
#ifndef H_ARKMINT_SCRIPT
#define H_ARKMINT_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CAardvarkCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, AardvarkCoin always counted CHECKMULTISIGs
