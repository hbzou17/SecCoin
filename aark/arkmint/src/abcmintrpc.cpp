...
{
    return GetBoolArg("-testnet", false) ? 18882 : 33666;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "Stop AardvarkCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AardvarkCoin server stopping";
}
...
//
// JSON-RPC protocol.  AardvarkCoin speaks version 1.0 for maximum compatibility,
