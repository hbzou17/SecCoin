AardvarkCoin-Qt: Qt5 GUI for AardvarkCoin
===============================
...
A warning for people using the *static binary* version of AardvarkCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of AardvarkCoin is linked against libdb (see also `this Debian issue`_).
