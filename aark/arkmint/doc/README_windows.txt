...
AardvarkCoin-Qt is the original AardvarkCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of AardvarkCoin transactions;
